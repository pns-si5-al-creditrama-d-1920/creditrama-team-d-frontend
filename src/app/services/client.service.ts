...
export class ClientService {
  ...
  getBankAccounts(userId: number): Observable<any> {
	return this.http.get(environment.BANK_SERVICE_URL + this.route + '/clients/' + userId + '/bank-accounts');
  }
  ...
  updateRecipients(userId: number, newRecipient: number) {
	...
	console.log(environment.BANK_SERVICE_URL + this.route + '/' + 'clients/' + userId + '/recipients');
	return this.http.post(environment.BANK_SERVICE_URL + this.route + '/' + 'clients/' + userId + '/recipients', newRecipient);
  }

  transfer(userId: number, transaction: BankTransactionRequest) {
	return this.http.post(environment.BANK_SERVICE_URL + this.route + '/clients/' + userId + '/transactions', transaction);
  }
  ...
  register(userName: string, userMail: string, userPassword: string): Observable<any> {
	return this.http.post(environment.BANK_SERVICE_URL + '/register', {
		email: userMail,
  ...
  dump(): Observable<any> {
	return this.http.get(environment.BANK_SERVICE_URL + '/dump');
  }
}
